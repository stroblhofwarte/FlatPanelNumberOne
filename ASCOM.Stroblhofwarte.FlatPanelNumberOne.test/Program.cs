...
namespace ASCOM
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ASCOM.DriverAccess.CoverCalibrator device = new ASCOM.DriverAccess.CoverCalibrator("ASCOM.ASCOM.Stroblhofwarte.FlatPanelNumberOne.CoverCalibrator");
#endif

...
;
[Setup]
AppID={{3BEC9161-145C-4447-B902-A11EB0B9C97D}
AppName=ASCOM Flat Panel Number One
AppVerName=ASCOM Flat Panel Number One Driver 0.9.0
AppVersion=0.9.0
...
MinVersion=6.1.7601
DefaultDirName="{cf}\ASCOM\FlatPanelNumberOne"
DisableDirPage=yes
DisableProgramGroupPage=yes
OutputDir="."
OutputBaseFilename="FlatPanelNumberOne Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\CoverCalibrator\FlatPanelNumberOne"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\FlatPanelNumberOne"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\_develop\ASCOM.Stroblhofwarte.FlatPanelNumberOne\ASCOM.Stroblhofwarte.FlatPanelNumberOne\bin\Release\ASCOM.Stroblhof.FlatPanelNumberOne.CoverCalibrator.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\_develop\ASCOM.Stroblhofwarte.FlatPanelNumberOne\ASCOM.Stroblhofwarte.FlatPanelNumberOne\README.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhof.FlatPanelNumberOne.CoverCalibrator.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhof.FlatPanelNumberOne.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Stroblhof.FlatPanelNumberOne.CoverCalibrator.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhof.FlatPanelNumberOne.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Stroblhof.FlatPanelNumberOne.CoverCalibrator.dll"""; Flags: runhidden 64bit; Check: IsWin64
